'''
file taken from https://github.com/yui-mhcp
'''
...
class DivideByStep(CustomScheduler):
    def __init__(self, factor=1., maxval=2e-4, minval=1e-4, **kwargs):
...
class WarmupScheduler(CustomScheduler):
    def __init__(self, factor=8, warmup_steps=2048, minval=1e-4, maxval=1e-2,
                 **kwargs):
