...
image_path = 'NSCLC-Radiomics/manifest-1603198545583/NSCLC-Radiomics/LUNG1-301/images/image_68.png'
images_path = 'NSCLC-Radiomics/manifest-1603198545583/NSCLC-Radiomics/LUNG1-301/images'
...
#
model = keras.models.load_model('small_2d_model.h5')
#
...
med_utils.createClients(general_path, 10)